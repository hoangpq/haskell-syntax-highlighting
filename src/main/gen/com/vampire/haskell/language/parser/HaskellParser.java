...
package com.vampire.haskell.language.parser;

import com.intellij.lang.PsiBuilder;
import com.intellij.lang.PsiBuilder.Marker;
import static com.vampire.haskell.language.psi.HaskellTypes.*;
import static com.vampire.haskell.language.psi.HaskellParserUtil.*;
...
public class HaskellParser implements PsiParser, LightPsiParser {
  ...
  // {}
  private static boolean consym_1(PsiBuilder b, int l) {
    return true;
  }
  ...
  // DOT     {}
  private static boolean varsym_9(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "varsym_9")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, HS_DOT);
    r = r && varsym_9_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // {}
  private static boolean varsym_9_1(PsiBuilder b, int l) {
    return true;
  }
