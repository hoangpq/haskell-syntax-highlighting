...
import com.vampire.haskell.language.impl.*;

public interface HaskellTypes {

  IElementType HS_CCONTEXT = new HaskellElementType("HS_CCONTEXT");
  IElementType HS_CDECL = new HaskellElementType("HS_CDECL");
  IElementType HS_CDECLS = new HaskellElementType("HS_CDECLS");
  IElementType HS_CDECL_DATA_DECLARATION = new HaskellElementType("HS_CDECL_DATA_DECLARATION");
  IElementType HS_CIDECL = new HaskellElementType("HS_CIDECL");
  IElementType HS_CIDECLS = new HaskellElementType("HS_CIDECLS");
  IElementType HS_CLASS_DECLARATION = new HaskellElementType("HS_CLASS_DECLARATION");
  IElementType HS_CLAZZ = new HaskellElementType("HS_CLAZZ");
  IElementType HS_COMMENTS = new HaskellElementType("HS_COMMENTS");
  IElementType HS_CONID = new HaskellElementType("HS_CONID");
  IElementType HS_CONSTR = new HaskellElementType("HS_CONSTR");
  IElementType HS_CONSTR_1 = new HaskellElementType("HS_CONSTR_1");
  IElementType HS_CONSTR_2 = new HaskellElementType("HS_CONSTR_2");
  IElementType HS_CONSTR_3 = new HaskellElementType("HS_CONSTR_3");
  IElementType HS_CONSYM = new HaskellElementType("HS_CONSYM");
  IElementType HS_DATA_DECLARATION = new HaskellElementType("HS_DATA_DECLARATION");
  IElementType HS_DATA_DECLARATION_DERIVING = new HaskellElementType("HS_DATA_DECLARATION_DERIVING");
  IElementType HS_DEFAULT_DECLARATION = new HaskellElementType("HS_DEFAULT_DECLARATION");
  IElementType HS_DERIVING_DECLARATION = new HaskellElementType("HS_DERIVING_DECLARATION");
  IElementType HS_DERIVING_VIA = new HaskellElementType("HS_DERIVING_VIA");
  IElementType HS_DOT_DOT = new HaskellElementType("HS_DOT_DOT");
  IElementType HS_EXPORT = new HaskellElementType("HS_EXPORT");
  IElementType HS_EXPORTS = new HaskellElementType("HS_EXPORTS");
  IElementType HS_EXPRESSION = new HaskellElementType("HS_EXPRESSION");
  IElementType HS_FIELDDECL = new HaskellElementType("HS_FIELDDECL");
  IElementType HS_FILE_HEADER = new HaskellElementType("HS_FILE_HEADER");
  IElementType HS_FIXITY_DECLARATION = new HaskellElementType("HS_FIXITY_DECLARATION");
  IElementType HS_FOREIGN_DECLARATION = new HaskellElementType("HS_FOREIGN_DECLARATION");
  IElementType HS_GENERAL_PRAGMA_CONTENT = new HaskellElementType("HS_GENERAL_PRAGMA_CONTENT");
  IElementType HS_GTYCON = new HaskellElementType("HS_GTYCON");
  IElementType HS_IMPORT_DECLARATION = new HaskellElementType("HS_IMPORT_DECLARATION");
  IElementType HS_IMPORT_DECLARATIONS = new HaskellElementType("HS_IMPORT_DECLARATIONS");
  IElementType HS_IMPORT_EMPTY_SPEC = new HaskellElementType("HS_IMPORT_EMPTY_SPEC");
  IElementType HS_IMPORT_HIDING = new HaskellElementType("HS_IMPORT_HIDING");
  IElementType HS_IMPORT_HIDING_SPEC = new HaskellElementType("HS_IMPORT_HIDING_SPEC");
  IElementType HS_IMPORT_ID = new HaskellElementType("HS_IMPORT_ID");
  IElementType HS_IMPORT_IDS_SPEC = new HaskellElementType("HS_IMPORT_IDS_SPEC");
  IElementType HS_IMPORT_PACKAGE_NAME = new HaskellElementType("HS_IMPORT_PACKAGE_NAME");
  IElementType HS_IMPORT_QUALIFIED = new HaskellElementType("HS_IMPORT_QUALIFIED");
  IElementType HS_IMPORT_QUALIFIED_AS = new HaskellElementType("HS_IMPORT_QUALIFIED_AS");
  IElementType HS_IMPORT_SPEC = new HaskellElementType("HS_IMPORT_SPEC");
  IElementType HS_INST = new HaskellElementType("HS_INST");
  IElementType HS_INSTANCE_DECLARATION = new HaskellElementType("HS_INSTANCE_DECLARATION");
  IElementType HS_INSTVAR = new HaskellElementType("HS_INSTVAR");
  IElementType HS_KIND_SIGNATURE = new HaskellElementType("HS_KIND_SIGNATURE");
  IElementType HS_LIST_TYPE = new HaskellElementType("HS_LIST_TYPE");
  IElementType HS_MODID = new HaskellElementType("HS_MODID");
  IElementType HS_MODULE_BODY = new HaskellElementType("HS_MODULE_BODY");
  IElementType HS_MODULE_DECLARATION = new HaskellElementType("HS_MODULE_DECLARATION");
  IElementType HS_NEWCONSTR = new HaskellElementType("HS_NEWCONSTR");
  IElementType HS_NEWCONSTR_FIELDDECL = new HaskellElementType("HS_NEWCONSTR_FIELDDECL");
  IElementType HS_NEWTYPE_DECLARATION = new HaskellElementType("HS_NEWTYPE_DECLARATION");
  IElementType HS_PRAGMA = new HaskellElementType("HS_PRAGMA");
  IElementType HS_QUALIFIER = new HaskellElementType("HS_QUALIFIER");
  IElementType HS_QUASI_QUOTE = new HaskellElementType("HS_QUASI_QUOTE");
  IElementType HS_Q_CON = new HaskellElementType("HS_Q_CON");
  IElementType HS_Q_CON_QUALIFIER = new HaskellElementType("HS_Q_CON_QUALIFIER");
  IElementType HS_Q_CON_QUALIFIER_1 = new HaskellElementType("HS_Q_CON_QUALIFIER_1");
  IElementType HS_Q_CON_QUALIFIER_2 = new HaskellElementType("HS_Q_CON_QUALIFIER_2");
  IElementType HS_Q_CON_QUALIFIER_3 = new HaskellElementType("HS_Q_CON_QUALIFIER_3");
  IElementType HS_Q_CON_QUALIFIER_4 = new HaskellElementType("HS_Q_CON_QUALIFIER_4");
  IElementType HS_Q_NAME = new HaskellElementType("HS_Q_NAME");
  IElementType HS_Q_NAMES = new HaskellElementType("HS_Q_NAMES");
  IElementType HS_Q_VAR_CON = new HaskellElementType("HS_Q_VAR_CON");
  IElementType HS_SCONTEXT = new HaskellElementType("HS_SCONTEXT");
  IElementType HS_SHEBANG_LINE = new HaskellElementType("HS_SHEBANG_LINE");
  IElementType HS_SIMPLECLASS = new HaskellElementType("HS_SIMPLECLASS");
  IElementType HS_SIMPLETYPE = new HaskellElementType("HS_SIMPLETYPE");
  IElementType HS_TEXT_LITERAL = new HaskellElementType("HS_TEXT_LITERAL");
  IElementType HS_TOP_DECLARATION = new HaskellElementType("HS_TOP_DECLARATION");
  IElementType HS_TTYPE = new HaskellElementType("HS_TTYPE");
  IElementType HS_TYPE_DECLARATION = new HaskellElementType("HS_TYPE_DECLARATION");
  IElementType HS_TYPE_EQUALITY = new HaskellElementType("HS_TYPE_EQUALITY");
  IElementType HS_TYPE_FAMILY_DECLARATION = new HaskellElementType("HS_TYPE_FAMILY_DECLARATION");
  IElementType HS_TYPE_FAMILY_TYPE = new HaskellElementType("HS_TYPE_FAMILY_TYPE");
  IElementType HS_TYPE_INSTANCE_DECLARATION = new HaskellElementType("HS_TYPE_INSTANCE_DECLARATION");
  IElementType HS_TYPE_SIGNATURE = new HaskellElementType("HS_TYPE_SIGNATURE");
  IElementType HS_VARID = new HaskellElementType("HS_VARID");
  IElementType HS_VARSYM = new HaskellElementType("HS_VARSYM");
  IElementType HS_VAR_CON = new HaskellElementType("HS_VAR_CON");
