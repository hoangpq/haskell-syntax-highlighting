...
public class HaskellQConQualifier4Impl extends ASTWrapperPsiElement implements HaskellQConQualifier4 {

  public HaskellQConQualifier4Impl(@NotNull ASTNode node) {
    super(node);
  }
