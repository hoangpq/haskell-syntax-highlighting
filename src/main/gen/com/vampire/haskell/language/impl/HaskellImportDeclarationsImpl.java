...
public class HaskellImportDeclarationsImpl extends ASTWrapperPsiElement implements HaskellImportDeclarations {

  public HaskellImportDeclarationsImpl(@NotNull ASTNode node) {
    super(node);
  }
