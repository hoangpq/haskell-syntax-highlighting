...
public class HaskellImportEmptySpecImpl extends ASTWrapperPsiElement implements HaskellImportEmptySpec {

  public HaskellImportEmptySpecImpl(@NotNull ASTNode node) {
    super(node);
  }
