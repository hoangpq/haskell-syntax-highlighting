...
public class HaskellDerivingDeclarationImpl extends ASTWrapperPsiElement implements HaskellDerivingDeclaration {

  public HaskellDerivingDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
