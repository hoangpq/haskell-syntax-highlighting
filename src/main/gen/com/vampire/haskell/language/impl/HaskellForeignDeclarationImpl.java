...
public class HaskellForeignDeclarationImpl extends ASTWrapperPsiElement implements HaskellForeignDeclaration {

  public HaskellForeignDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
