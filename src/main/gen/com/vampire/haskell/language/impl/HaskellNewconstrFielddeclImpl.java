...
public class HaskellNewconstrFielddeclImpl extends ASTWrapperPsiElement implements HaskellNewconstrFielddecl {

  public HaskellNewconstrFielddeclImpl(@NotNull ASTNode node) {
    super(node);
  }
