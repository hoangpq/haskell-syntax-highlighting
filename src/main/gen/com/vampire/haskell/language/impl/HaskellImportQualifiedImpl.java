...
public class HaskellImportQualifiedImpl extends ASTWrapperPsiElement implements HaskellImportQualified {

  public HaskellImportQualifiedImpl(@NotNull ASTNode node) {
    super(node);
  }
