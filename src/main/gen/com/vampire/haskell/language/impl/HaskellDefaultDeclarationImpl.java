...
public class HaskellDefaultDeclarationImpl extends ASTWrapperPsiElement implements HaskellDefaultDeclaration {

  public HaskellDefaultDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
