...
public class HaskellQConQualifierImpl extends ASTWrapperPsiElement implements HaskellQConQualifier {

  public HaskellQConQualifierImpl(@NotNull ASTNode node) {
    super(node);
  }
