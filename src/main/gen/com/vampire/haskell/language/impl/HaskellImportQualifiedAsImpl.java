...
public class HaskellImportQualifiedAsImpl extends ASTWrapperPsiElement implements HaskellImportQualifiedAs {

  public HaskellImportQualifiedAsImpl(@NotNull ASTNode node) {
    super(node);
  }
