...
public class HaskellTypeInstanceDeclarationImpl extends ASTWrapperPsiElement implements HaskellTypeInstanceDeclaration {

  public HaskellTypeInstanceDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
