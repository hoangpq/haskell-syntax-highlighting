...
public class HaskellTypeSignatureImpl extends ASTWrapperPsiElement implements HaskellTypeSignature {

  public HaskellTypeSignatureImpl(@NotNull ASTNode node) {
    super(node);
  }
